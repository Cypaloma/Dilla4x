...
> [!NOTE]
> This guide applies to the **Dilla4x-MIDI firmware (v0.3.0)**. For the QMK firmware, see the [Dilla4x-QMK Guide](How-to-Use-Dilla4x-QMK.md).
...
👉 Next: [Connecting to Your DAW](../sound/Music-Making-Overview.md)  
🎵 Also See: [Beginner Music Making Tips](../sound/Beginner-Guide.md)
